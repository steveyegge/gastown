...
func freezeSessionGroup(t *tmux.Tmux, sessionName string) error {
	return signalSessionGroup(t, sessionName, syscall.SIGTSTP)
}

func thawSessionGroup(t *tmux.Tmux, sessionName string) error {
	return signalSessionGroup(t, sessionName, syscall.SIGCONT)
}
