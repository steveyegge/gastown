...
func windowExists(_ *tmux.Tmux, session, windowName string) (bool, error) {
...
func createWindow(_ *tmux.Tmux, session, windowName, workDir, command string) error {
...
func selectWindow(_ *tmux.Tmux, target string) error {
