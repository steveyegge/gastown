...
func init() {
	...
	convoyCreateCmd.Flags().StringVar(&convoyBaseBranch, "base-branch", "", "Target branch for sling dispatch (default: main)")
...
func findStrandedConvoys(townBeads string) ([]strandedConvoyInfo, error) {
	...
	for _, convoy := range convoys {
		// Parse BaseBranch from convoy description fields.
