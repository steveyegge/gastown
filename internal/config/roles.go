...
func AllRoles() []string {
	return []string{"mayor", "deacon", "dog", "witness", "refinery", "polecat", "crew", "artisan", "architect", "conductor"}
}
...
func RigRoles() []string {
	return []string{"witness", "refinery", "polecat", "crew", "artisan", "architect", "conductor"}
}
