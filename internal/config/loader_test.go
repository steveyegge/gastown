...
// NOTE: TestBuildAgentStartupCommand, TestBuildPolecatStartupCommand, TestBuildCrewStartupCommand
// were removed - they tested upstream functions (BuildAgentStartupCommand, etc.) that don't exist
// in the working-tree architecture which uses factory.Start() instead.
...
// NOTE: TestBuildPolecatStartupCommandWithAgentOverride, TestBuildAgentStartupCommandWithAgentOverride,
// TestBuildCrewStartupCommandWithAgentOverride, TestBuildStartupCommand_UsesRigAgentWhenRigPathProvided,
// TestBuildStartupCommand_UsesRoleAgentsFromTownSettings, TestBuildStartupCommand_RigRoleAgentsOverridesTownRoleAgents,
// TestBuildAgentStartupCommand_UsesRoleAgents were removed - they tested upstream functions that don't exist
// in the working-tree architecture which uses factory.Start() instead.
...
// NOTE: TestExpectedPaneCommands was removed - it tested an upstream function that doesn't exist
// in the working-tree architecture.
