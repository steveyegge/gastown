...
// resolveJSONLPath returns the path to the beads JSONL file for the given beads directory.
...
// envHas checks if the environment has the given key set.
