...
* [gt mayor attach](../cli/gt_mayor_attach/)	 - Attach to the Mayor session
* [gt mayor restart](../cli/gt_mayor_restart/)	 - Restart the Mayor session
* [gt mayor start](../cli/gt_mayor_start/)	 - Start the Mayor session
* [gt mayor status](../cli/gt_mayor_status/)	 - Check Mayor session status
* [gt mayor stop](../cli/gt_mayor_stop/)	 - Stop the Mayor session
